...
mono_attributes = {'Hex': {'mass': {'03X': 72.0211, '02X': 42.0105, '15X': 27.9949, '13A': 60.0211, '24A': 60.0211,
                  ...
                  'HexNAc': {'mass': {'04A': 60.0211, '24A': 60.0211, '35A': 74.0368, '03A': 90.0317, '25A': 104.0473,
                                      '02A': 120.0423, '24X': 143.0583, 'HexNAc': 203.0794},
                  ...
                  'HexA': {'mass': {'02X': 42.0105, '02A': 134.02159, '24A': 60.0211, 'HexA': 176.03209},
                           'atoms': {'02X': [1, 2], '02A': [3, 4, 5, 6], '24A': [3, 4], 'HexA': [1, 2, 3, 4, 5, 6]}},
                  'dHex': {'mass': {'02X': 42.0105, '02A': 104.0474, 'dHex': 146.0579},
                           'atoms': {'02X': [1, 2], '02A': [3, 4, 5, 6], 'dHex': [1, 2, 3, 4, 5, 6]}},
                  ...
                  'HexNAc6S': {'mass': {'04A': 139.9779, '24A': 60.0211, '35A': 153.9936, '03A': 169.9885, '25A': 184.0041,
                                        '02A': 199.9991, '24X': 223.0151, 'HexNAc6S': 283.0362},
                               'atoms': {'04A': [5, 6], '24A': [3, 4], '35A': [4, 5, 6], '03A': [4, 5, 6], '25A': [3, 4, 5, 6],
                                         '02A': [3, 4, 5, 6], '24X': [1,2,5,6], 'HexNAc6S': [1, 2, 3, 4, 5, 6]}},
                  'HexNAcOS': {'mass': {'04A': 139.9779, '24A': 139.9779, '35A': 153.9936, '03A': 169.9885, '25A': 184.0041,
                                        '02A': 199.9991, '24X': 223.0151, 'HexNAcOS': 283.0362},
                               'atoms': {'04A': [5, 6], '24A': [3, 4], '35A': [4, 5, 6], '03A': [4, 5, 6], '25A': [3, 4, 5, 6],
                                         '02A': [3, 4, 5, 6], '24X': [1,2,5,6], 'HexNAcOS': [1, 2, 3, 4, 5, 6]}},
                  'Hex6S': {'mass': {'02X': 42.0105, '03X': 72.0211, '15X': 27.9949, '13A': 60.0211, '24A': 60.0211, '04A': 139.9779, '35A': 153.9936, '25A': 184.0041,
                                     '02A': 199.9991, 'Hex6S': 242.0096},
                            'atoms': {'02X': [1, 2], '03X': [1, 2, 3], '15X': [1], '13A': [2, 3], '24A': [3, 4], '04A': [5, 6], '35A': [4, 5, 6], '25A': [3, 4, 5, 6],
                                      '02A': [3, 4, 5, 6], 'Hex6S': [1, 2, 3, 4, 5, 6]}},
                  'Hex3S': {'mass': {'02X': 42.0105, '03X': 151.9779, '15X': 27.9949, '13A': 139.9779, '24A': 139.9779, '04A': 60.0211, '35A': 74.0368, '25A': 184.0041,
                                     '02A': 199.9991, 'Hex3S': 242.0096},
                            'atoms': {'02X': [1, 2], '03X': [1, 2, 3], '15X': [1], '13A': [2, 3], '24A': [3, 4], '04A': [5, 6], '35A': [4, 5, 6], '25A': [3, 4, 5, 6],
                                      '02A': [3, 4, 5, 6], 'Hex3S': [1, 2, 3, 4, 5, 6]}},
                  'HexOS': {'mass': {'02X': 42.0105, '03X': 151.9779, '15X': 27.9949, '13A': 139.9779, '24A': 139.9779, '04A': 139.9779, '35A': 153.9936, '25A': 184.0041,
                                     '02A': 199.9991, 'HexOS': 242.0096},
                            'atoms': {'02X': [1, 2], '03X': [1, 2, 3], '15X': [1], '13A': [2, 3], '24A': [3, 4], '04A': [5, 6], '35A': [4, 5, 6], '25A': [3, 4, 5, 6],
                                      '02A': [3, 4, 5, 6], 'HexOS': [1, 2, 3, 4, 5, 6]}},
                   'Man6P': {'mass': {'03X': 72.0211, '02X': 42.0105, '15X': 27.9949, '13A': 60.0211, '24A': 60.0211,
                                   '04A': 139.9874, '35A': 154.0031, '25A': 184.0136, '02A': 200.0086, 'Man6P': 242.0191},
                          'atoms': {'03X': [1, 2, 3], '02X': [1, 2], '15X': [1], '13A': [2, 3], '24A': [3, 4],
                                    '04A': [5, 6], '35A': [4, 5, 6], '25A': [3, 4, 5, 6], '02A': [3, 4, 5, 6], 'Man6P': [1, 2, 3, 4, 5, 6]}},
                   'Hex6P': {'mass': {'03X': 72.0211, '02X': 42.0105, '15X': 27.9949, '13A': 60.0211, '24A': 60.0211,
                                   '04A': 139.9874, '35A': 154.0031, '25A': 184.0136, '02A': 200.0086, 'Hex6P': 242.0191},
                          'atoms': {'03X': [1, 2, 3], '02X': [1, 2], '15X': [1], '13A': [2, 3], '24A': [3, 4],
                                    '04A': [5, 6], '35A': [4, 5, 6], '25A': [3, 4, 5, 6], '02A': [3, 4, 5, 6], 'Hex6P': [1, 2, 3, 4, 5, 6]}},
                  'Global': {'mass': {'H2O': -18.0105546, 'CH2O': -30.0106, 'C2H2O': -42.0106, 'CO2': -43.9898, 'C2H4O2': -60.0211,
                                      'SO4': -79.9568, 'PO4': -79.9663, 'C3H8O4': -108.0423, '+Acetonitrile': +42.0106, '+Acetate': 59.013851,
...
def get_global_mods(subg, node_dict, mode):
  ...
  if 'P' not in ''.join([node_dict[x] for x in subg.nodes()]):
