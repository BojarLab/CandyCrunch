...
from glycowork.glycan_data.loader import unwrap, stringify_dict
...
def wrap_inference(filename, glycan_class, libr = None, filepath = fp_in + "for_prediction/", bin_num = 2048, model = model_ft,
