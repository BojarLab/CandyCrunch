...
class TestCandyCrunch(unittest.TestCase):
    def test_candy_crumbs(self):
        ...
        'annotations': [['Y_2_Alpha','Z_1_Gamma'],['Y_2_Alpha','Y_1_Gamma'],['Z_1_Alpha'],['Y_1_Alpha'],['Y_3_Alpha','Z_1_Gamma'],[],['Z_2_Alpha','Z_2_Beta','M_CH2O'],['Y_2_Alpha','Z_2_Beta'],['Z_2_Alpha'],['Y_2_Alpha'],['Y_3_Alpha','Y_3_Beta'],['Z_3_Alpha'],['Y_3_Alpha'],['Y_2_Gamma'],['C_1_Alpha']],
        'ref': '10.1074/mcp.M116.067983'
        },
        ...
        for test_dict in test_dicts:
            ...
            total_score += score
        total_score = total_score/len(test_dicts)
